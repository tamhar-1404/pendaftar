...
<body>
    ...
    <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
        ...
        <li class="relative mt-5">
            <a href="{{ route('dudi.index') }}" class="flex h-12 cursor-pointer items-center rounded-[5px] px-6 py-4 text-[0.875rem] text-gray-600 outline-none transition duration-300 ease-linear hover:bg-blue-500 hover:text-white hover:outline-none focus:bg-blue-500 focus:text-white focus:outline-none active:bg-blue-500 active:text-white active:outline-none data-[te-sidenav-state-active]:text-white data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10 {{ request()->routeIs('dudi.index') ? 'bg-blue-500 text-white' : '' }}">
            ...
            <div class="panel">
                <div class="flex justify-between">
                    ...
                    <div class="kamu-tak-diajak flex justify-start items-center">
                        ...
                        {{-- serch --}}
                        <form action="{{route('jurnal_admin.create')}}" method="GET">
                            @csrf
                            <div class="mr-4 ">
                    ...
                    <div class="kamu-tak-diajak mb-5 flex flex-wrap  mt-5 items-center">
                        ...
                        <a href="jurnal_docx">
                            <button  class="flex gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="exportTable('txt')">
                                <svg
                                    width="22"
                                    height="22"
                                    viewBox="0 0 24 24"
                        ...
                        <button id="printButton" onclick="printPage()" class="flex gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="printTable">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                         ...
                         <table class="min-w-full text-left text-sm font-light">
                             ...
                             <tbody>
                                ...
                                <td class="whitespace-nowrap px-4 py-4 kamu-tak-diajak">
                                        <button  type="button" class="w-16 flex h-8 bg-white rounded-md border-2 border-[#00B7FF] justify-center items-center text-[#00B7FF] hover:bg-[#00B7FF] hover:text-white dark:bg-transparent" data-te-toggle="modal"
