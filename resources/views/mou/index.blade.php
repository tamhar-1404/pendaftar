                                            ...
                                            <tbody>
                                                <tr
                                                    ...
                                                    <td class="whitespace-nowrap px-6 py-4"><img
                                                            src="{{ asset('admin/assets/images/smk1panjen.jpg') }}"
                                                            width="100px" alt=""></td>
                                                    <td class="whitespace-nowrap px-6 py-4">SMKN 1 KEPANJEN</td>
                                                    <td class="whitespace-nowrap px-6 py-4">@smkn1kepanjen</td>
                                                    <td class="whitespace-nowrap px-6 py-4">+1 202 555 0197</td>
                                                    <td class="whitespace-nowrap px-6 py-4">Balearjosari, Malang</td>
