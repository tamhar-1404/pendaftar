                        ...
                        >
                            ...
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link">
                                    <div class="flex items-center">
                                        <svg  class="mt-0.5" viewBox="0 0 450 550"  xmlns="http://www.w3.org/2000/svg" >
                                            <g opacity="0.5">
                            ...
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link">
                                    <div class="flex items-center">
                                        <svg class="mt-1"  viewBox="0 0 1500 1500" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill="currentColor" d="M0 0v1200h1200V424.289l-196.875 196.875v381.961h-806.25v-806.25h381.961L775.711 0H0zm1030.008 15.161l-434.18 434.25L440.7 294.283L281.618 453.438L595.821 767.57l159.082-159.082l434.18-434.25l-159.082-159.081l.007.004z"/>
                                        </svg>
                            ...
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link">
                                    <div class="flex items-center">
                                        <svg class="mt-0.4" width="24" height="24" viewBox="0 0 650 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="menu nav-item relative">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="tables.html">Tata tertib</a>
                                    </li>
                                    <li>
                                        <a href="tables.html">Jadwal Piket</a>
                                    </li>
                                    <li>
                                        <a href="tables.html">Chat</a>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="animate__animated p-6" :class="[$store.app.animation]">
                    ...
                    <div x-data="sales">
                        <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="#" class="text-black hover:underline">Dashboard</a>
                            </li>
                            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                                <span>Rahmat Mahendra</span>
                            </li>
                        </ul>
