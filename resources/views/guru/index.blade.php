...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div class="main-content">
                        ...
                        @forelse ($mou as $data)
                            <div class="swiper-slide card dark:bg-black">
                                <div class="card-content ">
                                    <div class="image">
                                        <img src="{{ asset('storage/mou/. $logo') }}" alt=""
                                            width="180">
                                    </div>
                                </div>
                            </div>
            ...
            <section>
                <div class="swiper mySwiper1 container w-full">
                    <div class="swiper-wrapper content">
                        @forelse ($berita as $data)
                        <div class="swiper-slide ">
                            <div class="card-content image">
                                <img src="{{ asset('storage/fotoberita/'.$data->foto) }}" alt=""
                                    width="100%">
                            </div>
                            <div class="text-black w-full border border-1">
                                <div class="p-4">
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-500">{{ $data->kategori }}</span>
                                        <span class="text-sm text-gray-500">{{ $data->created_at->diffForHumans() }}</span>
                                    </div>
                                    <h2 class="text-xl font-semibold mt-2"><a
                                            href="{{ route('Berita.show', $data->id) }}">{{ Str::limit($data->judul, 15) }}</a></h2>
                                </div>
                            </div>
                        </div>
                            {{-- <div class="swiper-slide card dark:bg-black">
