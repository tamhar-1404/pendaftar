                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="image-container">
                                            <img src="{{ asset('storage/siswa/' . $aproval->sp_diri) }}"
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <h6 class="mb-1">CV :</h6>
                                        <div class="image-container">
                                            <img src="{{ asset('storage/siswa/' . $aproval->cv) }}"
                                                alt="" class="hover-image">
                                            <div class="overlay" data-bs-toggle="modal"
                                            ...
                                            <div class="modal fade bs-example-modal-center-cv" tabindex="-1"
                                                role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @if ($aproval->skck != null)
                                            <div class="image-container">
                                                ...
                                                <div class="modal fade skck" tabindex="-1"
                                                    role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body text-center">
                                                                ...
                                                                <a id="downloadLink" class="download-link hidden"
                                                                    href="#" download>>
                                                                    <button type="button"
                                                                        class="btn btn-primary waves-effect waves-light mt-2 me-1 download-button">
                                                                        Download
                                                                    </button>
                                                                </a>
                                                            </div>
