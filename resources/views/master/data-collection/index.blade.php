...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="float-end">
                <div class="dropdown">
                    <form action="{{ route('share') }}" target="_blank" method="POST">
                        @csrf
                        <input type="date" name="tanggal" class="form-control border py-2 px-4 rounded">
                        <button type="submit" class="btn btn-light" ><i class="mdi mdi-wallet me-1"></i> <span
                                class="d-none d-sm-inline-block">Send</span></button>
                    </form>
                </div>
            </div>
