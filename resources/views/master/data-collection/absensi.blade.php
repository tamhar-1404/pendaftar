        ...
        <div class="card-body">
            <div class="col-md-3">
                <div class="mb-3">
                    <form action="">
                        ...
                        <input class="form-control" type="search" value="{{ request()->name }}"
                            placeholder="Cari nama disini..." name="name" id="example-search-input">
                    </form>
                </div>
            </div>
            <div class="table-responsive">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        @php
                            $sortedStudents = $students->sortByDesc('id');
                        @endphp
