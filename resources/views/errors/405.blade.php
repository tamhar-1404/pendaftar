        ...
        <div class="full-width-screen">
            ...
            <div class="particles-bg" id="particles-js">
                <div class="content-detail">
                    <h1 class="global-title"><span>4</span><span>0</span><span>5</span></h1>

                    <h4 class="sub-title">Method Not Allowed</h4>

                    <p class="detail-text"><br> Method tidak di izinkan</p>

                    <div class="back-btn">
                        <a href="{{ url()->previous() }}" class="btn">Kembali ke halaman</a>
                    </div>
                </div></div>
            </div>
        </div>
