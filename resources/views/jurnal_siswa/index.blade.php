            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="basic" class="mt-0">
                    ...
                    <div class="mb-5 font-semibold kamu-tak-diajak">
                        <span class="text-xl font-bold mb-4">Jurnal /<span class="text-[#00B7FF]">
                        ...
                        <div class="kamu-tak-diajak md:flex md:justify-between mx-4 items-center">
                            @if (Auth::user()->Siswa->role == 'siswa')
                                <button data-modal-target="authentication-modal"
                                    ...
                                    class="flex gap-2 h-10 items-center w-full md:w-[11%] text-white bg-[#008ffb] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-[#008ffb] dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
