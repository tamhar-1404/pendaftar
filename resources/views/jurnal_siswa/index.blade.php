...
<body>
    <!-- screen loader -->
    <div class="kamu-tak-diajak screen_loader animate__animated fixed inset-0 z-[60] grid place-content-center bg-[#fafafa] dark:bg-[#060818]">
        <div class="center">
            <div class="ring">
            </div>
    ...
    <header class="kamu-tak-diajak shadow-sm w-full h-12 z-10 fixed">
        ...
        <div x-data="basic" class="mt-40">
            ...
            <div class="panel">
                ...
                <div class="kamu-tak-diajak flex justify-between items-center">
                    ...
                    <!-- Main modal -->
                    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="kamu-tak-diajak fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    ...
                    <a href="/export-to-docx" class="kamu-tak-diajak">
                        ...
                        <a href="/download-pdf-JurnalSiswa">
                            <button  class="flex gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                        ...
                        <button  id="printButton" onclick="printPage()" class="flex gap-2  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" @click="exportTable('json')" @click="printTable">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
    ...
    <script>
        ...
        const databaseData = [
            @foreach ($item as $items )
                { name: '{{$items -> nama}}', tanggal: '{{$modal -> tanggal}}', sekolah: ' {{$modal -> sekolah}}', kegiatan: '{{$modal -> kegiatan}}' },
            @endforeach
        ];
        ...
        // Mengatur judul dan header tabel
        const title = 'Data dari Database';
        const headers = Object.keys(data[0]);

        // Mengatur isi tabel
        const content = data.map(obj => Object.values(obj));
        ...
        // Mengunduh file PDF
        doc.save('database_data.pdf');
        }

        // Panggil fungsi createPDF dengan data dari database
        createPDF(databaseData);
