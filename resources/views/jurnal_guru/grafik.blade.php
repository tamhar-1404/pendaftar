        ...
        <div class="main-content">
            ...
            <div x-data="" class=" p-6">
                ...
                <div class="panel">
                    ...
                    {{-- grafik --}}
                    <div id="grafik_admin"
                        class=" w-full h-35  bg-white rounded-lg dark:bg-black mt-4 "style="box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.25); border-radius: 8px; ">
                                        ...
                                        <tbody>
                                            <tr
                                                ...
                                                <td
                                                    ...
                                                    excepturi velit quibusdam consequuntur et facilis, labore veritatis
                                                    debitis vitae enim libero odio soluta at cumque asperiores ea.
                                                    Autem, incidunt?</td>
                                                <td class="whitespace-nowrap px-6 py-4">
                                                    <img src="admin/assets/images/profile-1.jpeg" alt=""
                                                        srcset="">
                                                </td>
