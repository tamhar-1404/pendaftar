                ...
                <div class="animate__animated p-6" :class="[$store.app.animation]">
                    ...
                    <div x-data="sales">
                        <ul class="flex space-x-2 rtl:space-x-reverse">
                            ...
                            <h1>{{ session('decryptedSaldo') }}</h1>

                            <li>
                                <button data-modal-target="staticModal" data-modal-toggle="staticModal" class="bg-blue-400 flex border hover:border-blue-400 p-2 text-white font-semibold rounded-lg hover:bg-white hover:text-blue-400">Isi saldo</button>
                                            ...
                                            <div class="p-6 space-y-6">
                                                <div>
                                                    <div class="relative z-0 w-full mb-6 group">
                                                        <input type="text" name="saldo" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                        ...
                                        <div class=" w-9/12">
                                            <div id="accordion-collapse" data-accordion="collapse">
                                                ...
                                                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                                                    <p class="mb-2 text-gray-500 dark:text-gray-400">{!! $tatatertib->deskripsi !!}</p>
