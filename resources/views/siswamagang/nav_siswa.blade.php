        ...
        >
            ...
            <li class="menu nav-item relative">
                ...
                <a href="{{route('absensi_siswa.index')}}" class="nav-link">
                    <div class="flex items-center {{request()->routeIs('absensi.index') ? 'bg-blue-500 text-white' : ''}}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <li class="mt-1">
                    <button onclick="showStep(1)" class="border border-blue-400 px-4 py-1 text-blue-400 hover:bg-blue-400 hover:text-white rounded">Isi saldo</button>
