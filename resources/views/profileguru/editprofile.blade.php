                    ...
                    <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'users'" x-collapse class="sub-menu text-gray-500">
                                ...
                                <li>
                                    <a href="users-account-settings.html" class="active">Account Settings</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu nav-item">
                ...
                <div class="shadow-sm">
                    <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                            <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="assets_guru/images/logo.svg"
                                    alt="image" />
                                <span
                        ...
                        <div x-data="header"
                            ...
                            <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                                <a href="javascript:;"
                                    class="block rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                                    @click="toggle">
                                    <img :src="`assets_guru/images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                        ...
                                        <li>
                                            <a href="javascript:;" class="hover:text-primary"
                                                ...
                                                <img class="h-5 w-5 rounded-full object-cover"
                                                    :src="`assets_guru/images/flags/${item.value.toUpperCase()}.svg`"
                                                    alt="image" />
                    ...
                    <ul
                        ...
                        <li class="menu nav-item relative">
                            ...
                            <ul class="sub-menu">
                                <li class="relative">
                                    <a href="javascript:;" class="active">Users
                                        <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180">
                                            <svg width="16" height="16" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="users-account-settings.html" class="active">Account
                                                Settings</a>
                                        </li>
                                    </ul>
                                </li>
