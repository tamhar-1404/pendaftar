                            ...
                            <td  class="whitespace-nowrap px-6 py-2" >
                                <form action="{{ route('barang.destroy' , $barang->id) }}" method="post">
                                    ...
                                    <i  class="fa fa-pencil-square-o"></i>
                                        ...
                                        <button type="submit" class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"> <i class="animate-bounce fa fa-trash"></i></button>
                                </form>
                            </td>
                        </tr>
                        @empty
                ...
                <div class="p-6 space-y-6">
                    <div>
                        <p class="text-base leading-relaxed font-bold  text-gray-800 dark:text-gray-400">
                            ...
                            <input type="text" name="nama" value="{{ $barang->nama }}" class="border border-gray-400 rounded px-2 w-full py-1">
                    ...
                    <div>
                       ...
                       <img src="{{ asset('storage/pendataanbarang/' . $barang->foto) }}" class="w-20" alt="" srcset="">

                       <input type="file" name="foto" value="{{ $barang->foto }}" class="mt-2">
                    </div>
                    <div>
                        <p class="text-base leading-relaxed font-bold text-gray-800 dark:text-gray-400">
                            Kode barang
                        </p>
                        <input type="number" name="kode" value="{{ $barang->kode }}" class="border border-gray-400 w-full py-1 rounded px-2" id="">
                    </div>
                    <div>
                        <p class="text-base leading-relaxed font-bold text-gray-800 dark:text-gray-400">
                            Harga
                        </p>
                       <input type="text" name="harga" class="border border-gray-400 w-full py-1 px-2 rounded" value="{{ $barang->harga }}" id="">
                    </div>
                    <div>
                        <p class="text-base leading-relaxed font-bold text-gray-800 dark:text-gray-400">
                            Kategori
                        </p>
                       <select name="kategori" id="" class="border border-gray-400 w-full py-1 px-2 rounded">
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="border border-blue-500 px-5 text-base font-medium py-1 hover:bg-blue-500 hover:text-white  rounded">Edit</button>
                    </div>
                </div>
            </form>
            <!-- barang footer -->
