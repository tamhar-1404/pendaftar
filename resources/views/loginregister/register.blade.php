                ...
                <form method="POST" action="{{ route('postregister') }}" enctype="multipart/form-data"
                    ...
                    <div class="step step-2" id="step2">
                        ...
                        <div class="flex items-center justify-center mt-4">
                            <div class="flex ml-auto col">
                                <button type="button" onclick="prevStep()"
                                    class="prev-button w-full btn mt-10 h-10 bg-info font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                    Kembali
                                </button>
                                <button type="button" onclick="nextStep()"
                                    class="next-button w-full btn mt-10 h-10 bg-info font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                    Selanjutnya
                                </button>
                            </div>
                        </div>
