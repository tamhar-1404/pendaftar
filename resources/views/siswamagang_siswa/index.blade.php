            ...
            <div class="card pb-2">
              ...
              <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button class="Button w-[98.92px] self-stretch pl-[19.44px] pr-[22.48px] py-2 bg-slate-200 rounded-lg justify-center items-center gap-[5px] inline-flex" data-modal-show="staticModal {{ $siswa->id }}">
...
<form action="{{ route('siswamagang.store') }}" method="post">
    ...
    <div id="staticModal {{ $siswa->id }}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
