...
<body>
    ...
    <header class="shadow-sm w-full h-12 z-10 fixed">
        ...
        <nav class=" w-full  bg-white flex items-center gap-10  p-4">
            {{-- dashboard --}}
            <button
                class=" active flex gap-1 items-center text-gray-900 bg-white focus:outline-none hover:bg-[#24AEE4] hover:text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2 mr-2  my-2 ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            {{-- jurnal --}}
            <button
                class="flex gap-1 items-center text-gray-900 bg-white focus:outline-none hover:bg-[#24AEE4] hover:text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2 mr-2  my-2 ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div id="dropdownHover"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                    <li>
                        <a href="#"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tata
                            tertib</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Siswa</a>
                    </li>
                </ul>
            </div>
    ...
    <main class="main w-full px-5 pb-8 ">
        <div class="flex items-center justify-between py-5 lg:py-6">
            <div class="flex items-center  mt-20">
                <h2 class="text-xl font-medium text-slate-700 line-clamp-1 dark:text-navy-50 lg:text-1xl mt-14 pl-8">
                    Data Siswa
                </h2>
                        ...
                        <div x-data="usePopper({ placement: 'bottom-end', offset: 4 })" @click.outside="isShowPopper && (isShowPopper = false)"
                            ...
                            <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                                <div
                                    ...
                                    <ul>
                                        <li>
                                            <a href="http://127.0.0.1:8000/siswa_admin/detail"
                        ...
                        <div class="flex items-center w-full">
                            <div
                                ...
                                <button data-modal-target="staticModal{{ $siswa->id }}"
                                    ...
                                    class="Button w-[110px] self-stretch pl-[12.57px] pr-2 py-2 bg-rose-500 rounded-lg justify-end items-center gap-[5px] inline-flex">
                                    <div
