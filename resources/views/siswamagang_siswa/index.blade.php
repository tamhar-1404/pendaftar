        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            ...
            <div class="card pb-2">
              ...
              <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                ...
                <div class="Link w-10 h-6 px-2 pt-[1.00px] pb-[6.33px]bg-emerald-500 bg-opacity-10 rounded-full justify-start items-start inline-flex">
                    <div class="{{ $siswa->jurusan === 'RPL' ? 'text-green-500 text-[12px]' : 'text-blue-500 text-[12px]' }} flex items-center justify-center w-8 h-8 rounded-full font-medium leading-3 tracking-wide">{{ $siswa->jurusan }}</div>
                </div>

                <p class="text-xs+ mt-2">{{ $siswa->sekolah }}</p>
                <div class="flex items-center w-full">
                    <div class="w-full h-[36px] pl-[6.50px] pr-[4.16px] justify-center items-start gap-[11.42px] inline-flex mt-8">
                      <button data-modal-target="staticModal{{$siswa->id}}" data-modal-toggle="staticModal{{$siswa->id}}" class="Button w-[110px] self-stretch pl-[12.57px] pr-2 py-2 bg-rose-500 rounded-lg justify-end items-center gap-[5px] inline-flex" >
                      ...
                      <button class="Button w-[110px] self-stretch pl-[12.57px] pr-2 py-2 bg-gray-500 rounded-lg justify-center items-center gap-[5px] inline-flex" >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" color="white">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332 48.294 48.294 0 005.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                          </svg>
                        <div data-modal-target="staticModal" data-modal-toggle="staticModal" class="Laporkan text-center text-white text-[14px] font-medium leading-tight tracking-wide">Chat</div>
                      </button>
            ...
            <form action="{{ route('laporansiswa.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div id="staticModal{{$siswa->id}}"  tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="staticModal{{$siswa->id}}">
