          ...
          <div class="absolute top-0 right-0 mt-2 mr-2">
              <div x-data="{ isOpen: false }">
                ...
                >
                  <ul>
                    <li>
                      <a href="" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" @click="editItem()">Edit</a>
                    </li>
                    <li>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center text-xs text-slate-200">
                  <p class="flex items-center space-x-1">
                    ...
                    <span class="line-clamp-1">{{ $berita->kategori }}</span>
                  </p>
                  <div
                    class="mx-3 my-0.5 w-px self-stretch bg-white/20"
                  ></div>
                  <p class="shrink-0 text-tiny+">{{ $berita->created_at->diffForHumans() }}</p>
                </div>
