                    ...
                    <table class="w-full min-w-max">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="w-32 p-3 border border-solid border-gray-600 text-center">
                                    <a href="#">
                                        <img src="transaksi/images/single-product/sm/product2.webp" alt="product image"></a>
                                </td>
                                <td class="p-3 border border-solid border-gray-600 text-center">
                                    <a href="#" class="transition-all hover:text-orange">Birpod product unsde</a><span>m / gold</span>
                                </td>
                            ...
                            <tr>
                                <td class="w-32 p-3 border border-solid border-gray-600 text-center">
                                    <a href="#">
                                        <img src="transaksi/images/single-product/sm/product3.webp" alt="product image"></a>
                                </td>
                                <td class="p-3 border border-solid border-gray-600 text-center">
                                    <a href="#" class="transition-all hover:text-orange">Birpod product unsde</a><span>m / gold</span>
                                </td>
                            ...
                            <tr>
                                <td class="w-32 p-3 border border-solid border-gray-600 text-center">
                                    <a href="#">
                                        <img src="transaksi/images/single-product/sm/product4.webp" alt="product image"></a>
                                </td>
                                <td class="p-3 border border-solid border-gray-600 text-center">
                                    <a href="#" class="transition-all hover:text-orange">Birpod product unsde</a><span>m / gold</span>
                                </td>
