    ...
    <div class="flex flex-row ">
        ...
        <div class="container">
            <div class="grid grid-cols-1 gap-5">
                <div class="flex w-full justify-between  md:w-max-[50%] mt-2 rounded">
                    <div class="flex w-full justify-end font-semibold items-center  px-4 py-1 rounded">
                        <div class=" flex text-white items-center py-1 rounded bg-blue-400 px-3">
                ...
                <div class="overflow-x-auto">
                    ...
                    <div class="flex justify-between px-8 mt-4">
                        <p id="total_keseluruhan" class="hidden text-base font-semibold text-gray-700">Total
                            keseluruhan Rp. <span id="jumlah_semua"
                                class=" text-base font-semibold text-blue-400">0</span></p>
                        <input type="hidden" id="form_total_semua" value="0">
                        <button type="submit"
                            class="hidden bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded"
