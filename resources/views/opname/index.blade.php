                            ...
                            <td  class="whitespace-nowrap px-6 py-2" >
                                <form action="{{ route('opname.destroy' , $oname->id) }}" method="post">
                                    ...
                                    @csrf
                                        ...
                                        <button type="submit" class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"> <i class=" fa fa-trash"></i></button>
                                </form>
                            </td>
                        </tr>
                        @empty
