                        ...
                        <div class="panel">
                            <div class="flex justify-between">
                                ...
                                <div class="mb-5 flex flex-wrap  mt-5 items-center">
                                    <button type="button" class="bg-blue-500 border text-white flex px-3 py-2 rounded-md font-bold hover:bg-white hover:text-blue-500 hover:border-blue-500 " @click="exportTable('csv')">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                                    ...
                                    <button type="button" class="bg-blue-500 border text-white flex px-3 py-2 rounded-md font-bold hover:bg-white hover:text-blue-500 hover:border-blue-500 " @click="exportTable('txt')">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                                    ...
                                    <button type="button" class="bg-blue-500 border text-white flex px-3 py-2 rounded-md font-bold hover:bg-white hover:text-blue-500 hover:border-blue-500 " @click="exportTable('json')">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                                    ...
                                    <button type="button" class="bg-blue-500 border text-white flex px-3 py-2 rounded-md font-bold hover:bg-white hover:text-blue-500 hover:border-blue-500 " @click="printTable">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                                        ...
                                        <tbody>
                                          <tr
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <img src="admin/assets/images/profile-1.jpeg" alt="" srcset="">
                                            </td>
                                            <td class="whitespace-nowrap px-4 py-4" >
                                                <button class="w-16 flex h-8 bg-white rounded-md border-2 border-[#00B7FF] justify-center items-center text-[#00B7FF] hover:bg-[#00B7FF] hover:text-white dark:bg-transparent " data-te-toggle="modal"
