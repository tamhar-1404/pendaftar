...
<head>
    ...
    <link rel="stylesheet" href="siswa/css/highlight.min.css" />
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                            <img class="ml-[5px] w-8 flex-none" src="siswa/images/logo.svg" alt="image" />
                            <span
                    ...
                    <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'components'" x-collapse
                                ...
                                <li>
                                    <a href="components-accordions.html" class="active">Accordions</a>
                                </li>
                                <li>
                ...
                <div class="shadow-sm">
                    <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                            <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="siswa/images/logo.svg"
                                    alt="image" />
                                <span
                            ...
                            <ul class="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                                ...
                                <li>
                                    <a href="apps-chat.html"
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <circle r="3" transform="matrix(-1 0 0 1 19 5)"
                                                stroke="currentColor" stroke-width="1.5" />
                                            <path opacity="0.5"
                        ...
                        <div x-data="header"
                                ...
                                <a href="javascript:;" x-cloak x-show="$store.app.theme === 'system'"
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            d="M3 9C3 6.17157 3 4.75736 3.87868 3.87868C4.75736 3 6.17157 3 9 3H15C17.8284 3 19.2426 3 20.1213 3.87868C21 4.75736 21 6.17157 21 9V14C21 15.8856 21 16.8284 20.4142 17.4142C19.8284 18 18.8856 18 17 18H7C5.11438 18 4.17157 18 3.58579 17.4142C3 16.8284 3 15.8856 3 14V9Z"
                                            stroke="currentColor" stroke-width="1.5" />
                                        <path opacity="0.5" d="M22 21H2" stroke="currentColor"
                                            stroke-width="1.5" stroke-linecap="round" />
                                        <path opacity="0.5" d="M15 15H9" stroke="currentColor"
                                            stroke-width="1.5" stroke-linecap="round" />
                                    </svg>
                                </a>
                            </div>
                            ...
                            <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                                <a href="javascript:;"
                                    class="block rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                                    @click="toggle">
                                    <img :src="`siswa/images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                        ...
                                        <li>
                                            <a href="javascript:;" class="hover:text-primary"
                                                ...
                                                <img class="h-5 w-5 rounded-full object-cover"
                                                    :src="`siswa/images/flags/${item.value.toUpperCase()}.svg`"
                                                    alt="image" />
                            ...
                            <div class="dropdown flex-shrink-0" x-data="dropdown"
                                ...
                                <a href="javascript:;" class="group relative" @click="toggle()">
                                    <span><img
                                            ...
                                            src="siswa/images/user-profile.jpeg" alt="image" /></span>
                                </a>
                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                    ...
                                    <li>
                                        <a href="users-profile.html" class="dark:hover:text-white"
                                            @click="toggle">
                                            <svg class="h-4.5 w-4.5 ltr:mr-2 rtl:ml-2" width="18"
    ...
    <script src="siswa/js/highlight.min.js"></script>
...
<!-- Mirrored from html.vristo.sbthemes.com/components-accordions.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 May 2023 02:33:10 GMT -->
