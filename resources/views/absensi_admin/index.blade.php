                ...
                <div class="panel">
                    <div class="flex justify-between ">
                        ...
                        <div class="mb-5 flex flex-wrap  mt-5 items-center ">
                            <form action="{{ route('exportToDocxabsen') }}" method="get">
                                <input type="hidden" name="pencarian" value="{{ request('cari') }}">
                                <a>
                                    <button type="submit"
                            ...
                            <form action="{{ route('absensi_pdf_admin') }}" method="get">
                                <input type="hidden" name="pencarian" value="{{ request('cari') }}">
                                <a>
                                    <button type="submit"
                                            ...
                                            @forelse ($terima as $absen)
                                                <tr
                                                    ...
                                                    <td class="whitespace-nowrap px-6 py-2 font-bold">
                                                        {{ $no++ }}</td>
                                                    <td class="whitespace-nowrap px-6 py-2 capitalize tracking-wide">
                                                        {{ $absen->name }}</td>
                                                    <td class="whitespace-nowrap px-6 py-2 uppercase">
                                                        {{ $absen->sekolah }}</td>
                                                    @if (!empty($absen->absens[0]))
                                                        <td class="whitespace-nowrap px-6 py-2">
                                                            {{ $absen->absens[0]->tanggal }}</td>
                                                        <td class="whitespace-nowrap px-6 py-4">
                                                            {{ $absen->absens[0]->jam }}</td>
                                                        <td class="whitespace-nowrap px-6 py-2">
                                                            @if ($absen->absens[0]->keterangan === 'Hadir')
                                                                <span
                                                                    class=" text-green-500 font-sans md:font-serif font-medium tracking-wide capitalize">{{ $absen->absens[0]->keterangan }}</span>
                                                            @else
                                                                <span
                                                                    class=" text-red-600 font-sans md:font-serif font-medium tracking-wide capitalize">{{ $absen->absens[0]->keterangan }}</span>
                                                            @endif
                                                        </td>
                                                    @else
                                                        ...
                                                        <td class="whitespace-nowrap px-6 py-2">
                                                            <span
                                                                class=" text-red-500 font-sans md:font-serif font-medium tracking-wide capitalize">Belum
                                                                hadir</span>
                                                        </td>
                                                    @endif
                                                </tr>
