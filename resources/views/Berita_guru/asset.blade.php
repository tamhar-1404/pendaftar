...
<main class="main w-full px-4 pb-8">
  ...
  >
      ...
      <div class="absolute top-0 right-0 mt-2 mr-2">
          <div x-data="{ isOpen: false }">
            ...
            >
              <ul>
                <li>
                  <a href="{{ route('edit') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" @click="editItem()">Edit</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" @click="deleteItem()">Hapus</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="card">
      <img
        class="h-72 w-full rounded-lg object-cover object-center"
        src="admin/images/object/object-3.jpg"
        alt="image"
      />
      <div
        class="absolute inset-0 flex h-full w-full flex-col justify-end"
    ...
    <div class="card">
      <img
        class="h-72 w-full rounded-lg object-cover object-center"
        src="admin/images/object/object-4.jpg"
        alt="image"
      />
      <div
        class="absolute inset-0 flex h-full w-full flex-col justify-end"
    ...
    <div class="card">
      <img
        class="h-72 w-full rounded-lg object-cover object-center"
        src="admin/images/object/object-9.jpg"
        alt="image"
      />
      <div
        class="absolute inset-0 flex h-full w-full flex-col justify-end"
    ...
    <div class="card">
      <img
        class="h-72 w-full rounded-lg object-cover object-center"
        src="admin/images/object/object-8.jpg"
        alt="image"
      />
      <div
        class="absolute inset-0 flex h-full w-full flex-col justify-end"
    ...
    <div class="card">
      <img
        class="h-72 w-full rounded-lg object-cover object-center"
        src="admin/images/object/object-7.jpg"
        alt="image"
      />
      <div
        class="absolute inset-0 flex h-full w-full flex-col justify-end"
