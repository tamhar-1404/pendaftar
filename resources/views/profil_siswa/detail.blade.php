                            ...
                            <tr class="text-sm bg-[#E2E8F0] col-span-4">
                                ...
                                <td class="px-6 py-4">{{$pelangaran->deskripsi}}</td>
                                    ...
                                    @endforelse
                                            ...
                                            @forelse ($data as $pelangaran)
            <div id="staticModal{{ $pelangaran->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative w-full max-w-xl max-h-full">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 bg-blue-500">
                        <!-- Modal header -->
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                <p class="text-base leading-relaxed font-semibold  text-gray-800 dark:text-gray-400">
                                    Tanggal Pelanggaran :
                                </p>
