                                            ...
                                            <div class="grid flex-auto grid-cols-3 gap-5 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <input id="name" type="text"
                                                        placeholder="Nama langkap" value="{{$siswa->name}}" class="form-input bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly disabled/>
                                                </div>
                                                <div>
