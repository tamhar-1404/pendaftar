...
<body>
    ...
    <!-- Sidenav -->
    <nav id="sidenav-2"
    class="fixed left-0 top-0 z-[0] h-screen w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
    ...
    <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
        ...
        <li class="relative">
            ...
            <li class="relative">
                <a href=""
                    class="flex h-6 cursor-pointer items-center truncate rounded-[5px] py-4 pl-[3.4rem] pr-6 text-[0.78rem] text-gray-600 outline-none transition duration-300 ease-linear hover:bg-slate-50 hover:text-inherit hover:outline-none focus:bg-slate-50 focus:text-inherit focus:outline-none active:bg-slate-50 active:text-inherit active:outline-none data-[te-sidenav-state-active]:text-inherit data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10"
                    data-te-sidenav-link-ref>Pelanggaran siswa</a>
            </li>
            </ul>
        </li>
        {{-- lainnya --}}
            ...
            <div class="panel">
                <div class="flex justify-between">
                    ...
                    <div class="mb-5 flex flex-wrap  mt-5 items-center">
                        ...
                        <button type="button"id="addButton" class="flex gap-2  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
    ...
    <div
        ...
        id="exampleModalCenteredScrollable{{$items -> id}}"
        tabindex="-1"
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 w-30">
              <div class="max-w-7xl mx-auto">
                <div class="flex flex-col">
                 ...
                 <form action="{{ route('pelanggaran.store')   }}" class="mt-4" method="post" enctype="multipart/form-data">
                    @csrf
                      <div class="mt-4">
                        <label for="Nama" class="block text-gray-700 font-medium mb-2">nama</label>
                        <input type="text" placeholder="Masukkan nama " id="Kegiatan" name="nama" class="block w-full h-9 px-4 rounded-md bg-white border border-gray-300 focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                      </div>
                      <div class="mt-4">
                        <label for="Nama" class="block text-gray-700 font-medium mb-2">tanggal</label>
                        <input type="date" placeholder="Masukkan tanggal " id="sekolah" name="tanggal" class="block w-full h-9 px-4 rounded-md bg-white border border-gray-300 focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                      </div>
                      <div class="mt-4">
                        <label for="Nama" class="block text-gray-700 font-medium mb-2">sekolah</label>
                        <input type="text" placeholder="Masukkan sekolah  " id="Kegiatan" name="sekolah" class="block w-full h-9 px-4 rounded-md bg-white border border-gray-300 focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                      </div>
                      <div class="mt-4">
                        <label for="sekolah" class="block text-gray-700 font-medium mb-2">pelanggaran</label>
                    <textarea name="pelanggaran" id="" cols="65" rows="5" class="border border-1" placeholder="Masukkan pelanggaran"></textarea>
                    </div>
