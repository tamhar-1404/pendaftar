...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div class="main-content">
            ...
            @include('chat_guru.nav_chatguru')
            <!-- end header section -->
                        ...
                        <div class="panel absolute z-10 hidden w-full max-w-xs flex-none space-y-4 overflow-hidden p-4 xl:relative xl:block xl:h-full"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="flex-none"><img src="assets_guru/images/profile-34.jpeg"
                                            class="h-12 w-12 rounded-full object-cover" /></div>
                                    <div class="mx-3">
                                        <p class="mb-1 font-semibold">Aldi Taher</p>
                                        <p class="text-xs text-white-dark">Pembimbing SMKN 100 Malang</p>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <input type="text" class="peer form-input ltr:pr-9 rtl:pl-9"
                                    placeholder="Searching..." x-model="searchUser" @keyup="searchUsers" />
                                <div
                            ...
                            <div class="flex items-center justify-around text-xs">
                                <a href="/chatguru" type="button" class="group hover:text-primary">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <template x-if="!isShowUserChat">
                                <div class="relative flex h-full items-center justify-center p-4">
                                    ...
                                    <div class="flex flex-col items-center justify-center py-8">
                                        <!-- <img src="assets_guru/images/chat_img.svg" alt="image" class="w-[280px] md:w-[430px] mx-auto mb-8 h-[calc(100vh_-_320px)] min-h-[120px]" /> -->
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                                ...
                                                <ellipse cx="418.64354" cy="727.19434" rx="352"
                                                    ry="18"
                                                ...
                                                <div class="flex items-start gap-3"
                                                    ...
                                                    <div class="space-y-2">
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <div
                                                                :class="{ 'hidden': selectedUser.userId === message.fromUserId }">
                                                        ...
                                                        <div class="text-xs text-white-dark"
                                                            :class="{ 'ltr:text-right rtl:text-left': selectedUser.userId ===
                                                                    message.fromUserId }"
                                                ...
                                                <button type="button"
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="currentColor" stroke-width="1.5" />
                                                        <path opacity="0.5" d="M13.5 8L17 8"
                                                            stroke="currentColor" stroke-width="1.5"
                                                            stroke-linecap="round" />
                                                        <path opacity="0.5" d="M13.5 11L17 11"
                                                            stroke="currentColor" stroke-width="1.5"
                                                            stroke-linecap="round" />
                                                ...
                                                <button type="button"
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <path opacity="0.5"
                                                            ...
                                                            stroke="currentColor" stroke-width="1.5" />
                                                        <path d="M19 10H18" stroke="currentColor"
                                                            stroke-width="1.5" stroke-linecap="round" />
                                                    </svg>
                                                </button>
                                                <button type="button"
