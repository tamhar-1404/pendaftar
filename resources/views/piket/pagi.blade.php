                            ...
                            <div id="content3" class="card-content hidden">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4">
                                    @forelse ($laporan_piket as $data)
                                        <div class="w-full md:w-1/3 bg-white shadow-md rounded-lg">
                                            <div class="flex items-center p-4">
                                                @foreach ($siswa as $sis)
                                                    @if ($sis->name == $data->name)
                                                        <img src="{{ asset('storage/Siswa/' . $sis->foto_siswa) }}" class="w-14 h-14 rounded-full" alt="{{ $sis->name }}">
                                                    @endif
                                                @endforeach
                                                <div class="ml-3">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <div class="flex justify-between mt-4">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6 text-blue-500 cursor-pointer" data-modal-target="authentication-modal{{ $data->id }}" data-modal-toggle="authentication-modal{{ $data->id }}">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    </svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6 text-red-500 cursor-pointer">
                                        ...
                                        <!-- Main modal -->
                                        <div id="authentication-modal{{ $data->id }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto inset-0 md:h-auto">
                                            <div class="relative w-full max-w-md mx-auto">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow-md dark:bg-gray-700">
                                                    <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="authentication-modal{{ $data->id }}">
