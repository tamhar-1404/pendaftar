                                        ...
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-6 py-2">
                                                <div class="flex justify-between">
                                                    <form id="confirmation-form-{{ $topup->id }}" action="{{ route('aproval.update', $topup->id) }}" method="post" >
                                                        @csrf
                                                        @method('PUT')
                                                        <input type="hidden" name="saldo" placeholder="Saldo" value="{{ old('saldo', $topup->saldo) }}" required>
                                                        <button type="submit" id="submit-btn-{{ $topup->id }}" class="border border-blue-400 px-4 py-1 rounded hover:bg-blue-500 hover:text-white" onclick="tambah(event, {{ $topup->id }})">
